					...
					<a href="${pageContext.request.contextPath }/statement" style="text-decoration: none; ">
						<div class="card bg-light mb-3"
							...
							<div class="card-body">
								...
								<p class="card-text">Get transaction details of your account filtered by custom dates in the form of mini statement.</p>
							</div>
						</div>
					</a>
				</div>
					...
					<a href="${pageContext.request.contextPath }/help" style="text-decoration: none; ">
						<div class="card bg-light mb-3"
							...
							<div class="card-body">
								...
								<p class="card-text">Get transaction details of your account filtered by custom dates in the form of QnA.</p>
							</div>
						</div>
					</a>
				</div>
